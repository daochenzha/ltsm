TRAIN="/home/sl237/all_six_datasets/ETT-small/ETTh1.csv 
    ...
    /home/sl237/all_six_datasets/illness/national_illness.csv
...
for lr in 1e-3
    do
        ...
        downsample_rate=20
        freeze=0
        OUTPUT_PATH="output/ltsm_csv_large_lr${lr}_loraFalse_down${downsample_rate}_freeze${freeze}_e${epoch}"
