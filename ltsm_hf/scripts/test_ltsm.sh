...
pretrained="/home/sl237/ltsm/ltsm_hf/output/ltsm_train_large_lr1e-3_loraFalse_down180_freeze0_e2000/checkpoint-8000"

epoch=2000
downsample_rate=180
freeze=1
eval=1
OUTPUT_PATH="output/test_ltsm_train_medium_loraFalse_down${downsample_rate}"
